...
drama2 = {
    "제목": "태양의 후예",
    "장르": "밀리터리",
    "주제": "국가와 인종을 초월한 인본주의(마머니즘)와 헌신적인 사명감",
    "방영기간": "2016-02-24 ~ 2016-04-14",
    "배우": ["송중기", "송혜교", "진구", "김지원"],
    "명대사": "\"이 남자 저 남자 너무 걱정하는 남자가 많은 거 아닙니까? 헤프게 굴지 말고 강선생은 이 시간 이후 내 걱정만 합니다.\""
}
